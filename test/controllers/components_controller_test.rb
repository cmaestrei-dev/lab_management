...
class ComponentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create component" do
    assert_difference("Component.count") do
      post components_url, params: { component: { brand: @component.brand, computer_id: @component.computer_id, name: @component.name, serial_num: @component.serial_num, status: @component.status } }
    end
  ...
  test "should update component" do
    patch component_url(@component), params: { component: { brand: @component.brand, computer_id: @component.computer_id, name: @component.name, serial_num: @component.serial_num, status: @component.status } }
